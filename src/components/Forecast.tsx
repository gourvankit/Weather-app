...
const Forecast = ({ data }: props): JSX.Element => {
  ...
  return (
    ...
    md:px-10 lg:px-24 h-full lg:h-auto bg-white bg-opacity-20 backdrop-blur-ls rounded drop-shadow-lg"
    >
      <div className="mx-auto w-[300px]">
        <section className="text-center">
          <h2 className="text-2x1 font-black text-4xl">
        ...
        <section className="flex flex-wrap justify-between text-zinc-700">
          ...
          <Tile
            ...
            title={"Precipitation"}
            info={`${today.pop}%`}
            description={`${getPop(today.main.humidity)}`}
          />
          <Tile
            icon={"pressure"}
            title={"Pressure"}
